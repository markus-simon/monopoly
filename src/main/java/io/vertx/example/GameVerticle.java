...
public class GameVerticle extends AbstractVerticle {
    ...
    public void start() throws Exception {
        ...
        array.add(new JsonObject().put("id", 1 ).put("type", "street"    ).put("owner", "nobody").put("price", 40  ).put("rent", 4  ).put("house", 40  ).put("color", "#0c1d65").put("label1", "Badstraße"        ).put("label2", ""          ).put("label3", "Badstraße"       ));
        ...
        array.add(new JsonObject().put("id", 3 ).put("type", "street"    ).put("owner", "nobody").put("price", 80  ).put("rent", 8  ).put("house", 80  ).put("color", "#0c1d65").put("label1", "Turmstraße"       ).put("label2", ""          ).put("label3", "Turmstraße"      ));
        ...
        array.add(new JsonObject().put("id", 5 ).put("type", "street"    ).put("owner", "nobody").put("price", 500 ).put("rent", 50 ).put("house", 0   ).put("color", "#fff"   ).put("label1", "Südbahnhof"       ).put("label2", ""          ).put("label3", "Südbahnhof"      ));
        array.add(new JsonObject().put("id", 6 ).put("type", "street"    ).put("owner", "nobody").put("price", 120 ).put("rent", 12 ).put("house", 120 ).put("color", "#6ca1f1").put("label1", "Chaussee-"        ).put("label2", "straße"    ).put("label3", "Chausseestraße"  ));
        ...
        array.add(new JsonObject().put("id", 8 ).put("type", "street"    ).put("owner", "nobody").put("price", 120 ).put("rent", 12 ).put("house", 120 ).put("color", "#6ca1f1").put("label1", "Elisenstraße"     ).put("label2", ""          ).put("label3", "Elisenstraße"    ));
        array.add(new JsonObject().put("id", 9 ).put("type", "street"    ).put("owner", "nobody").put("price", 160 ).put("rent", 16 ).put("house", 160 ).put("color", "#6ca1f1").put("label1", "Poststraße"       ).put("label2", ""          ).put("label3", "Poststraße"      ));
        ...
        array.add(new JsonObject().put("id", 11).put("type", "street"    ).put("owner", "nobody").put("price", 200 ).put("rent", 20 ).put("house", 200 ).put("color", "#3e1f41").put("label1", "Seestraße"        ).put("label2", ""          ).put("label3", "Seestraße"       ));
        ...
        array.add(new JsonObject().put("id", 13).put("type", "street"    ).put("owner", "nobody").put("price", 200 ).put("rent", 20 ).put("house", 200 ).put("color", "#3e1f41").put("label1", "Hafenstraße"      ).put("label2", ""          ).put("label3", "Hafenstraße"     ));
        array.add(new JsonObject().put("id", 14).put("type", "street"    ).put("owner", "nobody").put("price", 240 ).put("rent", 24 ).put("house", 240 ).put("color", "#3e1f41").put("label1", "Neue Straße"      ).put("label2", ""          ).put("label3", "Neue Straße"     ));
        ...
        array.add(new JsonObject().put("id", 16).put("type", "street"    ).put("owner", "nobody").put("price", 280 ).put("rent", 28 ).put("house", 280 ).put("color", "#dd8426").put("label1", "Münchner"         ).put("label2", "Straße"    ).put("label3", "Münchner Straße"));
        ...
        array.add(new JsonObject().put("id", 18).put("type", "street"    ).put("owner", "nobody").put("price", 280 ).put("rent", 28 ).put("house", 280 ).put("color", "#dd8426").put("label1", "Wiener"           ).put("label2", "Straße"    ).put("label3", "Wiener Straße"   ));
        array.add(new JsonObject().put("id", 19).put("type", "street"    ).put("owner", "nobody").put("price", 320 ).put("rent", 32 ).put("house", 320 ).put("color", "#dd8426").put("label1", "Berliner"         ).put("label2", "Straße"    ).put("label3", "Berliner Straße" ));
        ...
        array.add(new JsonObject().put("id", 21).put("type", "street"    ).put("owner", "nobody").put("price", 360 ).put("rent", 36 ).put("house", 360 ).put("color", "#cc2e3c").put("label1", "Theater-"         ).put("label2", "straße"    ).put("label3", "Theaterstraße"   ));
        ...
        array.add(new JsonObject().put("id", 23).put("type", "street"    ).put("owner", "nobody").put("price", 360 ).put("rent", 36 ).put("house", 360 ).put("color", "#cc2e3c").put("label1", "Museums-"         ).put("label2", "straße"    ).put("label3", "Museumßtraße"   ));
        ...
        array.add(new JsonObject().put("id", 26).put("type", "street"    ).put("owner", "nobody").put("price", 440 ).put("rent", 44 ).put("house", 440 ).put("color", "#e4cd3f").put("label1", "Lessing-"         ).put("label2", "straße"    ).put("label3", "Lessingstraße"   ));
        array.add(new JsonObject().put("id", 27).put("type", "street"    ).put("owner", "nobody").put("price", 440 ).put("rent", 44 ).put("house", 440 ).put("color", "#e4cd3f").put("label1", "Schiller-"        ).put("label2", "straße"    ).put("label3", "Schillerstraße"  ));
        ...
        array.add(new JsonObject().put("id", 29).put("type", "street"    ).put("owner", "nobody").put("price", 480 ).put("rent", 48 ).put("house", 480 ).put("color", "#e4cd3f").put("label1", "Göthestraße"      ).put("label2", ""          ).put("label3", "Göthestraße"    ));
        array.add(new JsonObject().put("id", 30).put("type", "gotoprison").put("owner", ""      ).put("price", 0   ).put("rent", 0  ).put("house", 0   ).put("color", "#fff"   ).put("label1", "Gefängnis"        ).put("label2", ""          ).put("label3", "Gefängnis"       ));
        ...
        array.add(new JsonObject().put("id", 32).put("type", "street"    ).put("owner", "nobody").put("price", 520 ).put("rent", 52 ).put("house", 520 ).put("color", "#1e6351").put("label1", "Hauptstraße"      ).put("label2", ""          ).put("label3", "Hauptstraße"     ));
        ...
        array.add(new JsonObject().put("id", 34).put("type", "street"    ).put("owner", "nobody").put("price", 560 ).put("rent", 50 ).put("house", 500 ).put("color", "#1e6351").put("label1", "Bahnhofs-"        ).put("label2", "straße"    ).put("label3", "Bahnhofstraße"  ));
        ...
        array.add(new JsonObject().put("id", 37).put("type", "street"    ).put("owner", "nobody").put("price", 700 ).put("rent", 70 ).put("house", 700 ).put("color", "#1244b7").put("label1", "Parkstraße"       ).put("label2", ""          ).put("label3", "Parkstraße"      ));
